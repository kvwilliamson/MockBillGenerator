            ...
            <div className="w-1/3 bg-white p-6 rounded-xl shadow-lg h-fit">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        >
                            <option value="CLEAN">✅ Clean Bill (The charges and quantities on the bill perfectly match the services the patient actually received.)</option>
                            <option value="DUPLICATE">🔴 Duplicate Charges (The exact same service, medication, or supply appears multiple times on the bill for the same day.)</option>
                            <option value="QTY_ERROR">🔴 Quantity Error (The bill lists an impossible volume of supplies, such as being charged for 100 pairs of gloves for one nurse visit.)</option>
                            <option value="UPCODING">🔴 Upcoding (The patient is billed for a more complex and expensive version of a service than the one actually performed.)</option>
                            <option value="UNBUNDLING">🔴 Unbundling (A single procedure is broken into smaller parts and billed separately to increase the total cost.)</option>
                            <option value="MISSING_MODIFIER">🔴 Missing Modifier (The absence of a specific code prevents a standard discount from being applied to a secondary procedure.)</option>
                            <option value="MODIFIER_CONFLICT">🔴 Modifier Conflict (Incompatible codes are used together, which prevents the system from automatically discounting related procedures.)</option>
                            <option value="GLOBAL_PERIOD_VIOLATION">🔴 Global Period Violation (The patient is billed for a follow-up visit that should have been included for free in the "package price" of a previous surgery.)</option>
                            <option value="PHANTOM_BILLING">🔴 Phantom Billing (The patient is charged for medications, equipment, or tests that were never ordered or administered.)</option>
                            <option value="RECORD_MISMATCH">🔴 Record Mismatch (The itemized bill shows services that do not exist anywhere in the patient's actual clinical medical records.)</option>
                            <option value="TIME_LIMIT">🔴 Time Limit Violation (The patient is billed for more units of time than the patient actually spent in the session.)</option>
                            <option value="WRONG_PLACE_OF_SERVICE">🔴 Wrong Place of Service (A simple office visit is billed as a "Hospital Outpatient" service to trigger much higher facility fees.)</option>
                            <option value="REVENUE_CODE_MISMATCH">🔴 Revenue Code Mismatch (An incorrect department code is used to classify a cheap item into a more expensive billing category.)</option>
                            <option value="NO_SURPRISES_VIOLATION">🔴 No Surprises Act Violation (The patient is illegally billed for the "remainder" of a balance after insurance has already paid for an out-of-network emergency.)</option>
                            <option value="CMS_BENCHMARK">🔴 CMS Benchmark (The facility is charging a rate that is significantly higher than the fair market price established by Medicare.)</option>
                            <option value="DRG_OUTLIER">🔴 DRG Outlier (The hospital claims the patient's case was "exceptionally difficult" to trigger a massive add-on fee above the standard rate.)</option>
                            <option value="MED_NECESSITY_FAIL">🔴 Medical Necessity Fail (The patient is forced to pay out-of-pocket because the provider performed a service that insurance considers elective or unnecessary.)</option>
                            <option value="QUANTITY_LIMIT">🔴 Quantity Limit Exceeded (The patient is billed for more doses of a drug or units of service than is medically safe or allowed per day.)</option>
                            <option value="MATH_ERROR">🟠 Math Error (The "Total" column for a line item is higher than the "Quantity" multiplied by the "Unit Price.")</option>
                            <option value="BALANCE_MISMATCH">🟠 Balance Mismatch (The math on the summary page is wrong, showing a balance due that is higher than the charges minus payments.)</option>
                            <option value="GHOST_PROVIDER">🟡 Ghost Provider (The bill lists a provider the patient never saw or an ID number for someone who is no longer practicing.)</option>
                            <option value="NPI_INACTIVE">🟡 NPI Inactive (The patient is being billed by a provider who does not have a valid, active license to practice or bill insurance.)</option>
                            <option value="IMPOSSIBLE_DATE">🟡 Date Mismatch (The bill includes charges for dates before the patient was admitted or after the patient was discharged.)</option>
                        </select>
                    </div>
